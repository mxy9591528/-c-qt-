...
Q_CONSTINIT static const qt_meta_stringdata_Teacher_t qt_meta_stringdata_Teacher = {
    {
        ...
        QT_MOC_LITERAL(8, 7),  // "hungery"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 8)   // "foodname"
    },
    "Teacher",
    "hungery",
    "",
...
void Teacher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->hungery(); break;
        case 1: _t->hungery((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Teacher::hungery; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 1
void Teacher::hungery(QString _t1)
{
