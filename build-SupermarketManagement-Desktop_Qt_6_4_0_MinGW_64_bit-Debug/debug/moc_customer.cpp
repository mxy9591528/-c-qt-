...
#include <memory>
#include "../../SupermarketManagement/customer.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_customer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_customer_t qt_meta_stringdata_customer = {
    {
        QT_MOC_LITERAL(0, 8),  // "customer"
        QT_MOC_LITERAL(9, 7),  // "cusExit"
        QT_MOC_LITERAL(17, 0),  // ""
        QT_MOC_LITERAL(18, 19),  // "on_exit_btn_clicked"
        QT_MOC_LITERAL(38, 21),  // "on_search_btn_clicked"
        QT_MOC_LITERAL(60, 18)   // "on_buy_btn_clicked"
    },
    "customer",
    "cusExit",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_customer[] = {
...
Q_CONSTINIT const QMetaObject customer::staticMetaObject = { {
    ...
    qt_meta_stringdata_customer.offsetsAndSizes,
    qt_meta_data_customer,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_customer_t,
        // Q_OBJECT / Q_GADGET
...
void customer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &customer::cusExit; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
