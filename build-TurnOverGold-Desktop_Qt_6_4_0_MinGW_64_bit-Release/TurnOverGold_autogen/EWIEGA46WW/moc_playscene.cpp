...
#include <memory>
#include "../../../TurnOverGold/playscene.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_PlayScene_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_PlayScene_t qt_meta_stringdata_PlayScene = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_PlayScene[] = {
...
Q_CONSTINIT const QMetaObject PlayScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_PlayScene.offsetsAndSizes,
    qt_meta_data_PlayScene,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_PlayScene_t,
        // Q_OBJECT / Q_GADGET
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &PlayScene::backsignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
